...
public class QuanLyNhanVien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(139, 177, 116));
        ...
        jLabel18.setForeground(new java.awt.Color(234, 181, 99));
        jLabel18.setText("Quản Lý Nhân Viên");
        jPanel1.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 30, -1, -1));
    ...
    // GEN-FIRST:event_tblNhanvienMouseClicked
    // // TODO add your handling code here:
    ...
    private void btnTimkiemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnTimkiemActionPerformed
        ...
        if (nv == null) {
            ...
            tblModel.addRow(new Object[] {
                    nv.getMaNV(), nv.getMatKhau(), nv.getHoTen(), nv.getVaitro(), nv.getTuoi(), nv.getGioiTinh(),
        ...
        for (NhanVien nv1 : listnv) {
            tblModel.addRow(new Object[] {
                    nv1.getMaNV(), nv1.getMatKhau(), nv1.getHoTen(), nv1.getVaitro(), nv1.getTuoi(), nv1.getGioiTinh(),
                    nv1.getSdt(), nv1.getDiaChi()
            });
        }
